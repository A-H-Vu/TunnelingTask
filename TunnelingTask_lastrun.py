...
expName = 'TunnelingTask'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Andrew\\Documents\\Work\\Projects\\tunnelingTask\\TunnelingTask_lastrun.py',
...
trialComponents = [trialMouse, trialCursor, trialPolygon, trialStart, trialEnd, trialText, trialBrush]
...
thisExp.addData('trialBrush.started', trialBrush.tStartRefresh)
thisExp.addData('trialBrush.stopped', trialBrush.tStopRefresh)
